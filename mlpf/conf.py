...
ELEM_TYPES = {
    ...
    Dataset.CMS_TICL.value: [0, 1, 2, 3, 4],  # 1=track, 2=EM_TS, 3=HAD_TS, 4=GSF
...
ELEM_TYPES_NONZERO = {
    ...
    Dataset.CMS_TICL.value: [1, 2, 3, 4],  # track, EM_TS, HAD_TS, GSF
...
CLASS_LABELS = {
    Dataset.CMS.value: [0, 211, 130, 1, 2, 22, 11, 13, 15],
    Dataset.CMS_TICL.value: [0, 211, 130, 22, 11, 13],  # we never actually predict 15/taus (not there in targets)
...
CLASS_NAMES_LATEX = {
    ...
    Dataset.CMS_TICL.value: ["none", "Charged Hadron", "Neutral Hadron", r"$\gamma$", r"$e^\pm$", r"$\mu^\pm$"],
...
CLASS_NAMES = {
    ...
    Dataset.CMS_TICL.value: ["none", "chhad", "nhad", "gamma", "ele", "mu"],
...
CLASS_NAMES_CAPITALIZED = {
    ...
    Dataset.CMS_TICL.value: ["none", "Charged hadron", "Neutral hadron", "Photon", "Electron", "Muon"],
